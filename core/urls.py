...
urlpatterns = [
    ...
    path('fee-category-batch/', views.fee_category_batch_view, name='fee-category-batch'),
    path('fee-category-batch/apply/', views.fee_category_batch_apply, name='fee-category-batch-apply'),
    path('guardian-sync/', views.guardian_sync_view, name='guardian-sync'),
    path('guardian-sync/csv-preview/', views.guardian_sync_csv_preview, name='guardian-sync-csv-preview'),
    path('guardian-sync/csv-apply/', views.guardian_sync_csv_apply, name='guardian-sync-csv-apply'),
    path('guardian-sync/lookup/', views.guardian_sync_lookup, name='guardian-sync-lookup'),
    path('guardian-sync/create-student/', views.guardian_sync_create_student, name='guardian-sync-create-student'),
    path('guardian-sync/apply/', views.guardian_sync_apply, name='guardian-sync-apply'),
    path('student/<int:pk>/link-user/', views.link_user_to_student, name='link-user-to-student'),
    path('student/<int:pk>/unlink-user/', views.unlink_user_from_student, name='unlink-user-from-student'),
    path('student/<int:pk>/roster-quick-edit/', views.roster_quick_edit_get, name='roster-quick-edit'),
    path('student/<int:pk>/roster-quick-edit/save/', views.roster_quick_edit_save, name='roster-quick-edit-save'),
    ...
    path('api/user-search/', views.user_search_api, name='user-search-api'),
    path('finance/payments/history/', views.FeePaymentListView.as_view(), name='payment-history'),
    path('finance/payments/<int:payment_id>/revert/', views.revert_fee_payment, name='revert-fee-payment'),
]
